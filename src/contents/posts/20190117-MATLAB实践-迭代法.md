...
（1）命令行窗口：
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/d0b4ae6472a9b8da48885382e03459e5.png)



（2）绘图窗口（蓝色为Jacobi迭代误差，红色为Gauss-Seidel迭代误差，横轴为迭代次数）：
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/a7f7273d944f17c73f38b7cc9aba221d.png)
